...
namespace Application.Features.Models.Queries
{
    public class GetListModelQuery :IRequest<ModelListModel>
    {
        ...
        public class GetListBrandQueryHandler : IRequestHandler<GetListModelQuery, ModelListModel>
        {
            private readonly IModelRepository _modelRepository;
            private readonly IMapper _mapper;

            public GetListBrandQueryHandler(IModelRepository modelRepository, IMapper mapper)
            {
